package com.changxiao.example.photowallfallsdemo.widget;
...
import com.changxiao.example.photowallfallsdemo.R;
import com.changxiao.example.photowallfallsdemo.data.Images;
import com.changxiao.example.photowallfallsdemo.utils.ImageLoader;
...
/**
 * Created by Chang.Xiao on 2016/4/5 18:11.
 *
 * @version 1.0
 */
public class MyScrollView extends ScrollView implements View.OnTouchListener {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && !loadOnce) {
            ...
            firstColumn = (LinearLayout) findViewById(R.id.first_cloumn);
            secondColumn = (LinearLayout) findViewById(R.id.second_cloumn);
            thirdColumn = (LinearLayout) findViewById(R.id.third_cloumn);
