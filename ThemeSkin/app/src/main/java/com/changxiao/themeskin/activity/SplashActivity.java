...
import com.changxiao.themeskin.ui.viewpagerindicator.CirclePageIndicator;
import com.changxiao.themeskin.utils.SharedPreferencesUtil;
...
public class SplashActivity extends BaseActivity {
    ...
    protected void init(Bundle savedInstanceState) {
        boolean firstTimeUse = SharedPreferencesUtil.getInstance(this).getBoolean("first-time-use", true);
        if(firstTimeUse) {
            initGuideGallery();
        } else {
            initLaunchLogo();
