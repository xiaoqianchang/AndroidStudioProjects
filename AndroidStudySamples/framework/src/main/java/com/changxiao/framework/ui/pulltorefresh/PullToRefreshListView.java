...
import com.changxiao.framework.http.ZRRetrofit;
import com.changxiao.framework.ui.pulltorefresh.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public void updateLoadMoreViewText(List data) {
        ...
        } else if(data.size() < ZRRetrofit.PAGE_SIZE) {
