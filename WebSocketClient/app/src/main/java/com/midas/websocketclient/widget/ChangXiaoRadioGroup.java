 ...
 *
 */
public class ChangXiaoRadioGroup extends LinearLayout {
    ...
    public ChangXiaoRadioGroup(Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }

    public ChangXiaoRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(ChangXiaoRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == ChangXiaoRadioGroup.this && child instanceof RadioButton) {
                int id = child.getId();
            ...
            } else if (parent == ChangXiaoRadioGroup.this
