 ...
 * @version 1.0
 */
public class ZRSwipeLayout extends ViewGroup {
    ...
    public ZRSwipeLayout(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        init(context);
    }

    public ZRSwipeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
        init(context);
    }
    ...
    @SuppressLint("NewApi")
    public ZRSwipeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
